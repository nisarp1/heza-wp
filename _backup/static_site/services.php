<?php
$page_title = "Our Services - HEZA FLEET";
...
<section class="page-title dark"
    style="padding: 160px 0; background: url('images/new/page-banners/3.png') center center no-repeat; background-size: cover;">
    ...
    <div class="content-wrap pb-0">
        ...
        <div class="section m-0" style="padding: 100px 0;">
            <div class="running-car mt-6">
                <img class="car" src="images/new/sliding-bus.png" alt="Sliding Bus">
        ...
        <div class="section m-0"
            style="background: #FFF url('images/new/section-bg.jpg') left bottom no-repeat; background-size: cover; padding: 120px 0;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="h2 fw-bold mb-4">Need a Custom Transport Solution?</h2>
                        <a href="contact-us.php" class="button button-color button-large button-rounded">Contact Us
                            Today</a>
                    </div>
                </div>
            </div>
